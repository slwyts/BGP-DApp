  ...
  return (
    <>
      <motion.div
        ...
        className={cn(
          "absolute left-0 top-20 m-auto h-14 w-px rounded-full bg-linear-to-t from-white via-white to-transparent shadow-[0_0_10px_rgba(255,255,255,0.8)]",
  ...
  return (
    <div {...props} className={cn("absolute z-50 h-2 w-2", props.className)}>
      <motion.div
        ...
        className="absolute -inset-x-10 top-0 m-auto h-2 w-10 rounded-full bg-linear-to-r from-transparent via-white to-transparent blur-sm shadow-[0_0_20px_rgba(255,255,255,1)]"
      ></motion.div>
      {spans.map((span) => (
        <motion.span
          key={span.id}
